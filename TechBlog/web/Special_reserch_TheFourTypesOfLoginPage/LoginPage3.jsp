<%-- 
 I thought about hiding message then showing it, but thats too not god.
...
This is very useless page because i cant show too many messages here
--%>
                ...
                <div class="row">
                    <div class="col-md-4 offset-4">
                        <div class="card">
                            ...
                            <div id="errorMsg1" class="alert alert-danger" role="alert" hidden>
                                Invalid Details !
                            </div>
                            <div id="errorMsg2" class="alert alert-danger" role="alert" hidden>
                                Login Success 
                            </div>
                            <div id="errorMsg3" class="alert alert-danger" role="alert" hidden>
                                Logout Success
                            </div>
                                                        ...
                                                        $('#reg_form').on('submit', function (event) {
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                success: function (data, textStatus, jqXHR)
                                                                {
                                                                    ...
                                                                    if (data.trim() === "Logout Success.") {
                                                                        $('#errorMsg2').show();
                                                                        location.reload(false);
                                                                    }
                                                                    if (data.trim() === "Wrong username/password.") {
                                                                        $('#errorMsg3').show();
                                                                        location.reload(false);
                                                                    }
                                                                    else {
