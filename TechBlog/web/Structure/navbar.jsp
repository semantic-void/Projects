            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <%  post_dao posting = new post_dao(connection.connect());
                            ArrayList<Category> List = posting.getCategories();
                            for (Category cats : List) {
                        %>
                        <!--<li>--> 
                        <a href="#" onclick="getPostsById(<%= cats.getCid()%>, this)" class="list-group-item list-group-item-action c-link"><%=cats.getCategory()%></a>
                        <!--</li>-->
                        <%        }
                        %>
